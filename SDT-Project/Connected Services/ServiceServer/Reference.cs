...
namespace SDT_Project.ServiceServer {
    ...
    public interface IServiceServer {
        ...
        void SendLetter(string email, string body, string subject, bool isBodyHtml);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceServer/SendLetter")]
        System.Threading.Tasks.Task SendLetterAsync(string email, string body, string subject, bool isBodyHtml);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceServer/GetUserBalance", ReplyAction="http://tempuri.org/IServiceServer/GetUserBalanceResponse")]
        double GetUserBalance(uint id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceServer/GetUserBalance", ReplyAction="http://tempuri.org/IServiceServer/GetUserBalanceResponse")]
        System.Threading.Tasks.Task<double> GetUserBalanceAsync(uint id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceServer/SetUserBalance")]
        void SetUserBalance(int id, double price);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceServer/SetUserBalance")]
        System.Threading.Tasks.Task SetUserBalanceAsync(int id, double price);
    }
    ...
    public partial class ServiceServerClient : System.ServiceModel.DuplexClientBase<SDT_Project.ServiceServer.IServiceServer>, SDT_Project.ServiceServer.IServiceServer {
        ...
        public void SendLetter(string email, string body, string subject, bool isBodyHtml) {
            base.Channel.SendLetter(email, body, subject, isBodyHtml);
        }
        
        public System.Threading.Tasks.Task SendLetterAsync(string email, string body, string subject, bool isBodyHtml) {
            return base.Channel.SendLetterAsync(email, body, subject, isBodyHtml);
        }
        
        public double GetUserBalance(uint id) {
            return base.Channel.GetUserBalance(id);
        }
        
        public System.Threading.Tasks.Task<double> GetUserBalanceAsync(uint id) {
            return base.Channel.GetUserBalanceAsync(id);
        }
        
        public void SetUserBalance(int id, double price) {
            base.Channel.SetUserBalance(id, price);
        }
        
        public System.Threading.Tasks.Task SetUserBalanceAsync(int id, double price) {
            return base.Channel.SetUserBalanceAsync(id, price);
        }
    }
}
